        ...
        <section className="journey-grid">
          <article className="journey-card journey-upload">
            ...
            <div className="upload-tray">
              ...
              <label className="button button-secondary">{upload.file ? 'Replace' : 'Choose file'}<input aria-label="Choose prescription evidence" type="file" accept="image/jpeg,image/png,image/webp,application/pdf" disabled={fileControlDisabled} onChange={(event) => selectFile(event.target.files?.[0])} /></label>
            </div>
